                        ...
                        @foreach ($policy as $pol)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $pol->pol_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $pol->pol_id }}">
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/center/policy/update/' . $pol->pol_id) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="pol_description">Description:</label>
                                                    <textarea class="form-control summernote" name="pol_description">{!! $pol->pol_description !!}</textarea>
                                                </div>
