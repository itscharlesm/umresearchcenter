                        ...
                        @foreach ($umasenso as $umas)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $umas->umas_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $umas->umas_id }}">
                            ...
                            <!-- Modal for UMAsenso -->
                            <div class="modal fade" id="updateDescriptionModal-{{ $umas->umas_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/office/umasenso/update/' . $umas->umas_id) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="umas_description">Description:</label>
                                                    <textarea class="form-control summernote" name="umas_description">{!! $umas->umas_description !!}</textarea>
                                                </div>
