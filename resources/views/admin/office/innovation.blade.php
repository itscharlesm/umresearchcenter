...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">INNOVATION AND TECHNOLOGY SUPPORT OFFICE (ITSO)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ITSO</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        @foreach ($innovation as $inno)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $inno->inno_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $inno->inno_id }}">
                            ...
                            <!-- Modal for Innovation -->
                            <div class="modal fade" id="updateDescriptionModal-{{ $inno->inno_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/office/innovation/update/' . $inno->inno_id) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="inno_description">Description:</label>
                                                    <textarea class="form-control summernote" name="inno_description">{!! $inno->inno_description !!}</textarea>
                                                </div>
