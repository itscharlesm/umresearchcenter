                        ...
                        @foreach ($technology as $tech)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $tech->tech_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $tech->tech_id }}">
                            ...
                            <div class="modal fade" id="updateDescriptionModal-{{ $tech->tech_id }}" tabindex="-1"
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/journal/economy/update/' . $tech->tech_id) }}"
                                                ...
                                                <div class="form-group">
                                                    <label for="tech_description">Description:</label>
                                                    <textarea class="form-control summernote" name="tech_description">{!! $tech->tech_description !!}</textarea>
                                                </div>
