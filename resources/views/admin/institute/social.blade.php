                        ...
                        <tbody>
                            @foreach ($soc_description as $soc)
                                <tr style="vertical-align: middle;">
                                    <td style="vertical-align: middle;">{!! $soc->soc_description !!}</td>
                                    <td style="vertical-align: middle;">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal"
                                            data-target="#updateDescriptionModal-{{ $soc->soc_id }}">
                                            <span class="fa fa-edit"></span> Update
                                        </a>
                                    </td>
                                    <div class="modal fade" id="updateDescriptionModal-{{ $soc->soc_id }}"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="{{ url('admin/institute/economy/update/' . $soc->soc_id) }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-12">
