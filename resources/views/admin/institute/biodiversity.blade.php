                        ...
                        @foreach ($bio_description as $bio)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $bio->bio_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $bio->bio_id }}">
                            ...
                            <!-- Modal for Biodiversity -->
                            <div class="modal fade" id="updateDescriptionModal-{{ $bio->bio_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/institute/biodiversity/update/' . $bio->bio_id) }}"
                                                method="POST">
                                                @csrf
