...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">JOURNAL OF TROPICAL COLEOPTEROLOGY (JTC)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">JTC</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        @foreach ($tropical as $tro)
                            <div class="col-md-12">
                                <div class="card mb-3 shadow-sm border rounded">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">{!! $tro->tro_description !!}</p>
                                    </div>
                                    <div class="card-footer bg-light text-right">
                                        <a class="btn btn-warning btn-sm activate-btn" href="javascript:void(0)"
                                            data-toggle="modal" data-target="#updateDescriptionModal-{{ $tro->tro_id }}">
                            ...
                            <!-- Modal for Policy -->
                            <div class="modal fade" id="updateDescriptionModal-{{ $tro->tro_id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/journal/tropical/update/' . $tro->tro_id) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="tro_description">Description:</label>
                                                    <textarea class="form-control summernote" name="tro_description">{!! $tro->tro_description !!}</textarea>
                                                </div>
