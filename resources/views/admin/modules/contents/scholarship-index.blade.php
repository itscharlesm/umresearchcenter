                                ...
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            ...
                                            {{ \Carbon\Carbon::parse($content->scho_date_created)->format('F d, Y') }}<br>
                                            <strong>Status:</strong>
                                            {{ $content->scho_active ? 'Activated' : 'Deactivated' }}<br>
                                        </p>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-0 border-0 p-4">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/content/create-scholarship') }}" class="row" method="POST">
