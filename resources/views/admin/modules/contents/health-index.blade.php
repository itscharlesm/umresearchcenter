        ...
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom d-flex justify-content-between">
                    <h2 class="mb-3">Health Services</h2>
                                ...
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            ...
                                            {{ \Carbon\Carbon::parse($content->hlt_date_created)->format('F d, Y') }}<br>
                                            <strong>Status:</strong>
                                            {{ $content->hlt_active ? 'Activated' : 'Deactivated' }}<br>
                                        </p>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-0 border-0 p-4">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/content/create-health') }}" class="row" method="POST">
