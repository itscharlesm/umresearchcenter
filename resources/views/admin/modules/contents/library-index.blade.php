        ...
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom d-flex justify-content-between">
                    <h2 class="mb-3">Library Services</h2>
                        ...
                        @foreach ($contents as $content)
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $content->lib_title }}</h5>
                                        <p class="card-text mr-3">
                                            {!! $content->lib_desc !!}
                                        </p>
                                        <p>
                                            <strong>Date Created:</strong>
                                            {{ \Carbon\Carbon::parse($content->lib_date_created)->format('F d, Y') }}<br>
                                            <strong>Status:</strong>
                                            {{ $content->lib_active ? 'Activated' : 'Deactivated' }}<br>
                                        </p>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-0 border-0 p-4">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/content/create-library') }}" class="row" method="POST">
