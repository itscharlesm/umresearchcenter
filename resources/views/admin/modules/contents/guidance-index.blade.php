        ...
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom d-flex justify-content-between">
                    <h2 class="mb-3">Guidance Services</h2>
                        ...
                        @foreach ($contents as $content)
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $content->gui_title }}</h5>
                                        <p class="card-text mr-3">
                                            {!! $content->gui_desc !!}
                                        </p>
                                        <p>
                                            <strong>Date Created:</strong>
                                            {{ \Carbon\Carbon::parse($content->gui_date_created)->format('F d, Y') }}<br>
                                            <strong>Status:</strong>
                                            {{ $content->gui_active ? 'Activated' : 'Deactivated' }}<br>
                                        </p>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content rounded-0 border-0 p-4">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/content-service/create-guidance') }}" class="row" method="POST">
