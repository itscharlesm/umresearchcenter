    ...
    <section class="section ">
        <div class="container">
            <div class="content-header" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-delay="100"
                ...
                <x-content-header title=" Journal of Criminal Justice Studies" />
            </div>
            <x-breadcrumb :items="[
                ['label' => 'Home', 'url' => route('home'), 'active' => false],
                [
                    'label' => ' Journal of Criminal Justice Studies',
                    'url' => '#',
                    'active' => true,
                ],
            ]" />
            ...
            <article class="col-md-12 order-2 order-md-2 mt-5">
                <h3 class="text-justify">
                    <a href="#">Work Productivity and Crime Prevention Effectiveness of Police Officers in Pagalungan,
                        Maguindanao</a>
                </h3>
                <div class="row align-items-space-between">
                    <div class="col-md-8">
                        <h4>Jomar D. Akmad, Mujahid M. Labas, Jestony S. Laguiban, Tambilingan D. Latip, Norhamed M. Usman,
                            Jesus E.
                            Calotes Jr.</h4>
                    </div>
                    <div class="col-md-4">
