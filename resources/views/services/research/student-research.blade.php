    ...
    <section class="section ">
        <div class="container">
            <div class="content-header" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-delay="100"
                ...
                <x-content-header title=" Student Researches" />
            </div>
            <x-breadcrumb :items="[
                ['label' => 'Home', 'url' => route('home'), 'active' => false],
                [
                    'label' => ' Student Researches',
                    'url' => '#',
                    'active' => true,
                ],
            ]" />
                ...
                <article class="col-md-6 mb-4 mb-md-0">
                    <a href="#">
                        <img class="img-fluid" data-aos="zoom-in-right" data-aos-duration="1000" data-aos-delay="100"
                            data-aos-once="false" src="{{ asset('images/research/akademia-student-1.webp') }}"
                            alt="akademia student 1">
                    </a>
                </article>
                <article class="col-md-6 mb-4 mb-md-0">
                    <a href="#">
                        <img class="img-fluid" data-aos="zoom-in-right" data-aos-duration="1000" data-aos-delay="100"
                            data-aos-once="false" src="{{ asset('images/research/akademia-student-2.webp') }}"
                            alt="akademia student 2">
                    </a>
                </article>
            </div>
        </div>
